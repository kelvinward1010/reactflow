    ...
    return (
        ...
        <Box className='form-box'>
            ...
            >
                ...
                >
                    <Input color={textColor} prefix={<UserOutlined className="site-form-item-icon" />} onChange={handleChange}/>
                </Form.Item>
                ...
                <Form.Item
                    ...
                    hasFeedback
                >
                    <Input.Password color={textColor} prefix={<LockOutlined className="site-form-item-icon" />} onChange={handleChange}/>
                </Form.Item>
